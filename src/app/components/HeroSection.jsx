      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-8 place-self-center text-center sm:text-left justify-self-start">
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-lg">
            Join the ultimate Crusader 2 Tournament designed by Hawt and
            Letonetma. Experience the thrill, strategize your moves, and emerge
            as the champion in this epic showdown!
          </p>
          <div>
