    ...
    >
      ...
      <div className="text-center  mt-12">
        ...
        <div className="container mx-auto mt-4 text-center">
          ...
          <p className="mt-4">
            <strong>Letonetma vs Hawt</strong> 3-1{" "}
            <a
              href="https://www.youtube.com/live/05IO10_tGzo?si=78br3_Lhxi9VwlIj"
              target="_blank"
            >
              Match Replay
            </a>
          ...
          <p className="mt-4">
            <strong>Hawt vs Hakerxus</strong> 3-1{" "}
            <a
              href="https://www.youtube.com/watch?v=b6xcjwDtJlk&t=4184s"
              target="_blank"
            >
              Match Replay
            </a>
      ...
      <div className="space-y-12">
        <div className="text-center">
          ...
          <p className="text-lg mt-4 mb-6">
            ...
            Hawt.If you want to stream games or help in any other ways, contact
            us on steam
          </p>
        </div>
        <p className="py-6">&nbsp;</p>
